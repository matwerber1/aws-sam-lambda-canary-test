...
This is a sample template for aws-sam-lambda-canary-test - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name aws-sam-lambda-canary-test \
...
```bash
sam logs -n HelloWorldFunction --stack-name aws-sam-lambda-canary-test --tail
```
...
```bash
aws cloudformation delete-stack --stack-name aws-sam-lambda-canary-test
```
